...
<div class="container mt-4">
    ...
    <div class="d-flex mb-4">
        <form action="{{ route('admin.product.search') }}" method="GET" class="d-flex w-100 me-2">
            ...
            <form action="{{ route('admin.product.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <button type="button" class="btn btn-outline-secondary" onclick="document.getElementById('imageInput').click()">Choose</button>
                    </div>
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-warning text-white" style="background-color: #f4a261;">Update</button>
